...
import json
import psycopg
from src.ingestao import processar_pipeline
from src.bancos import carregar_dados_postgres, carregar_dados_mongodb, obter_conexao_postgres
from src.ia import MotorIA
from src.recomendacao import gerar_recomendacoes_usuario
